...
public class SagaREST {
	...
	public ResponseEntity<ClienteDTO> iniciaSagaAutocadastro(@RequestBody ClienteDTO cliente)
	...
	public ResponseEntity<ClienteDTO> iniciaSagaAlteraPerfil(@RequestBody ClienteDTO cliente)
			throws JsonProcessingException {
		var json = objectMapper.writeValueAsString(cliente);
		try {
			var registro = rabbitTemplate.convertSendAndReceive(Constants.FILA_SAGA, json);
...
//	public ResponseEntity<void> iniciaSagaGerenteRemover(@PathVariable idGerente)
//			throws JsonProcessingException {
//		var json = objectMapper.writeValueAsString(idGerente);
//		try {
//			var registro = rabbitTemplate.convertSendAndReceive(Constants.FILA_SAGA, json);
//			String jsonReg = objectMapper.writeValueAsString(registro);
//			var clienteDTO = objectMapper.readValue(jsonReg, ClienteDTO.class);
...
//	}
	...
	public ResponseEntity<ClienteDTO> iniciaSagaGerenteInserir(@RequestBody GerenteDTO gerente)
			throws JsonProcessingException {
