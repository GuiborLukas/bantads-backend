...
public class MovimentacaoD implements Serializable {
	...
	public MovimentacaoD() {
		super();
	}

	public MovimentacaoD(Date data, String tipo, Long clienteOrigem, Long clienteDestino, double valor) {
		super();
		this.id = id;
		this.data = data;
		this.tipo = tipo;
